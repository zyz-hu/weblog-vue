    ...
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <div class="flex justify-center gap-2">
                <!-- GitHub -->
                <svg @click="jump(blogSettingsStore.blogSettings.githubHomepage)" v-if="blogSettingsStore.blogSettings.githubHomepage" data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom"
                ...
                <!-- Gitee -->
                <svg @click="jump(blogSettingsStore.blogSettings.giteeHomepage)" v-if="blogSettingsStore.blogSettings.giteeHomepage" data-tooltip-target="gitee-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- 知乎 -->
                <svg @click="jump(blogSettingsStore.blogSettings.zhihuHomepage)" v-if="blogSettingsStore.blogSettings.zhihuHomepage" data-tooltip-target="zhihu-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- CSDN -->
                <svg @click="jump(blogSettingsStore.blogSettings.csdnHomepage)" v-if="blogSettingsStore.blogSettings.csdnHomepage" data-tooltip-target="csdn-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
